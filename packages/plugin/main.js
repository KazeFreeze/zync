...
// ../../node_modules/.pnpm/@lifeomic+attempt@3.1.0/node_modules/@lifeomic/attempt/dist/es6/src/index.js
...
// ../../node_modules/.pnpm/@hocuspocus+provider@2.15.3_y-protocols@1.0.7_yjs@13.6.31__yjs@13.6.31/node_modules/@hocuspocus/provider/dist/hocuspocus-provider.esm.js
...
var length$1 = (obj) => keys2(obj).length;
...
!hasParam2("no-colors") && (!isNode2 || process.stdout.isTTY || forceColor2) && (!isNode2 || hasParam2("color") || forceColor2 || getVariable2("COLORTERM") !== null || (getVariable2("TERM") || "").includes("color"));
...
var create8 = (s) => new Error(s);
var errorUnexpectedEndOfArray3 = create8("Unexpected end of array");
var errorIntegerOutOfRange3 = create8("Integer out of Range");
var Decoder2 = class {
  /**
...
var Observable2 = class {
   ...
   */
  on(name, f) {
    setIfUndefined2(this._observers, name, create$1).add(f);
  }
  /**
   * @param {N} name
   * @param {function} f
   ...
   */
  emit(name, args2) {
    return from2((this._observers.get(name) || create$2()).values()).forEach((f) => f(...args2));
  }
  destroy() {
    this._observers = create$2();
  }
...
var encodeQueryParams = (params3) => map2(params3, (val, key) => `${encodeURIComponent(key)}=${encodeURIComponent(val)}`).join("&");
var MessageType;
...
var SyncStepTwoMessage = class extends OutgoingMessage {
  ...
  get(args2) {
    ...
    writeVarString3(this.encoder, args2.documentName);
    writeVarUint3(this.encoder, this.type);
    writeSyncStep2(this.encoder, args2.document);
    return this.encoder;
  }
};
...
var HocuspocusProvider = class extends EventEmitter {
  ...
  send(message, args2, broadcast = false) {
    if (!this.isConnected) {
      return;
    }
    if (broadcast) {
      this.mux(() => {
        this.broadcast(message, args2);
      });
    }
  ...
  broadcast(Message, args2) {
    ...
    new MessageSender(Message, args2).broadcast(this.broadcastChannel);
  }
...
var uuidv4Template2 = "10000000-1000-4000-8000" + -1e11;
...
// ../../node_modules/.pnpm/y-indexeddb@9.0.12_yjs@13.6.31/node_modules/y-indexeddb/src/y-indexeddb.js
...
// ../../node_modules/.pnpm/y-codemirror.next@0.3.5_@codemirror+state@6.6.0_@codemirror+view@6.43.1_yjs@13.6.31/node_modules/y-codemirror.next/src/index.js
var cmView4 = __toESM(require("@codemirror/view"), 1);
var cmState4 = __toESM(require("@codemirror/state"), 1);

// ../../node_modules/.pnpm/y-codemirror.next@0.3.5_@codemirror+state@6.6.0_@codemirror+view@6.43.1_yjs@13.6.31/node_modules/y-codemirror.next/src/y-range.js
...
// ../../node_modules/.pnpm/y-codemirror.next@0.3.5_@codemirror+state@6.6.0_@codemirror+view@6.43.1_yjs@13.6.31/node_modules/y-codemirror.next/src/y-sync.js
...
// ../../node_modules/.pnpm/y-codemirror.next@0.3.5_@codemirror+state@6.6.0_@codemirror+view@6.43.1_yjs@13.6.31/node_modules/y-codemirror.next/src/y-remote-selections.js
...
// ../../node_modules/.pnpm/y-codemirror.next@0.3.5_@codemirror+state@6.6.0_@codemirror+view@6.43.1_yjs@13.6.31/node_modules/y-codemirror.next/src/y-undomanager.js
...
// src/binding.ts
function buildBinding(ytext, awareness) {
  const undoManager = new UndoManager(ytext);
  const collab = yCollab(ytext, awareness, { undoManager });
  const undoRedoKeymap = import_state.Prec.highest(
...
// src/main.ts
var RELAY_URL = "ws://127.0.0.1:1234";
var TOKEN = "dev-static-token";
var ZyncSpike = class extends import_obsidian.Plugin {
  sessions = /* @__PURE__ */ new Map();
  bindingCompartment = new import_state2.Compartment();
  async onload() {
  ...
  ensureSession(path) {
    ...
    const idb = new IndexeddbPersistence(`zync:${path}`, doc2);
    s = { doc: doc2, provider, idb };
    this.sessions.set(path, s);
    console.log(`[zync] session for ${path}`);
    return s;
  }
  syncActiveLeaf(retries = 5) {
    ...
    new import_obsidian.Notice(`Zync bound: ${file.path}`, 1500);
  }
  onunload() {
